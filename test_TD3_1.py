...
class QNetwork(Model):
    ...
    def __init__(self, num_inputs, num_actions, hidden_dim, init_w=3e-3):
        ...
        self.linear3 = Dense(n_units=1, W_init=w_init, in_channels=hidden_dim, name='q3')#输出是Q值，所以为1
...
class TD3_Trainer():
    ...
    def __init__(
        ...
        self.policy_optimizer = tf.optimizers.Adam(policy_lr)   #选择优化器
    ...
    #在更新的时候进行软更新
    def target_soft_update(self, net, target_net, soft_tau):#可以调整更新速率
    ...
    def update(self, batch_size, eval_noise_scale, reward_scale=10., gamma=0.9, soft_tau=1e-2):
        ...
        target_q_min = tf.minimum(self.target_q_net1(target_q_input), self.target_q_net2(target_q_input)) #TD ERROR
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        while frame_idx < max_frames:           #小于最大步数，就继续训练
            ...
            state = state[0].astype(np.float32)    #整理state的类型
